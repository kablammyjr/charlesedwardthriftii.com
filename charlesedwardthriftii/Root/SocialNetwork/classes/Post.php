...
class Post {
    ...
    public static function link_add($text) {
        ...
        foreach ($text as $word) {
            ...
            if (substr($word, 0, 1) == "@") {
                ...
                $newstring .= "<a href='/profile?username=".substr($word, 1)."'>".htmlspecialchars($word)." </a>";

            } else if (substr($word, 0, 1) == "#") {

                $newstring .= "<a href='/search?result=%23".substr($word, 1)."'>".htmlspecialchars($word)." </a>";   
    ...
    public static function displayPosts($userid, $username, $loggedInUserId) {
        ...
        foreach($dbposts as $p) {
            ...
            <form action='/profile?username=$username&postid=".$p['id']."' method='POST'>
