...
HeaderFooter::getHeader("Change Password");
...
<form action="<?php if (!$tokenIsValid) { echo '/changepassword'; } else { echo '/changepassword?token='.$token.'';} ?>" method="POST"><p></p>
<?php if (!$tokenIsValid) { echo '<input type="password" name="oldpassword" value="" placeholder="Current Password"><p></p>'; } ?>
<input type="password" name="newpassword" value="" placeholder="New Password"><p></p>
<input type="password" name="newpasswordrepeat" value="" placeholder="Repeat Password"><p></p>
